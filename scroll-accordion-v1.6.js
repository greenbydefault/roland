(function() {
  ...
  const CFG = {
    ...
    // ⚙️ HIER ANPASSEN: Wie viel Scroll pro Step? (höher = langsamer)
    // Standard: 1.8 = fast 2x Viewport-Höhe pro Step
    // Empfehlung: 1.5 - 3.0
  ...
  class AccordionInstance {
    ...
    setDeckHeight() {
      ...
      const totalHeight = vh * steps * CFG.scrollMultiplier;
    ...
    handleScroll() {
      ...
      const scrollProgress = scrollY - top;
      const scrollPerStep = vh * CFG.scrollMultiplier;
      
      let index = Math.floor(scrollProgress / scrollPerStep);
